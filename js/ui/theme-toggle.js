/* ============================================================
   ...
   ============================================================
   Jhey 的 Night && Day Toggle（原版移植，等比缩放到 100px）
   原始：https://codepen.io/jh3y/pen/LYgjpYZ
   MIT License
    ...
    connectedCallback() {
        ...
        style.textContent = `
            :host {
                ...
                z-index: 1000;
                display: block;
                transform: scale(0.2);   /* 保留缩放，视觉宽度 100px */
            ...
            .pilot-bear {
                ...
                translate:
                    calc((0 - (1 - var(--dark, 0))) * (var(--width) + 100%))
                ...
                <span aria-hidden="true" class="pilot__container">
                    <span class="pilot-bear">
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" fill="none" viewBox="0 0 1448 938">
                            ...
                            <defs>
                                <linearGradient id="b" x1="682" x2="860" y1="205" y2="182" gradientUnits="userSpaceOnUse"><stop stop-color="#fff"/><stop offset=".375" stop-color="#fff" stop-opacity="0"/></linearGradient>
                                <linearGradient id="c" x1="444" x2="643" y1="325" y2="321" gradientUnits="userSpaceOnUse"><stop stop-color="#fff"/><stop offset=".443" stop-color="#fff" stop-opacity="0"/></linearGradient>
                                <linearGradient id="d" x1="0" x2="119.743" y1="541.075" y2="541.075" gradientUnits="userSpaceOnUse"><stop offset=".25" stop-color="#FF2626"/><stop offset=".25"/></linearGradient>
                                <linearGradient id="e" x1="1232" x2="160" y1="521" y2="521" gradientUnits="userSpaceOnUse"><stop/><stop offset="1" stop-opacity="0"/></linearGradient>
                                <linearGradient id="g" x1="626" x2="208" y1="754" y2="754" gradientUnits="userSpaceOnUse"><stop/><stop offset="1" stop-opacity="0"/></linearGradient>
                                <linearGradient id="h" x1="636" x2="193" y1="44" y2="44" gradientUnits="userSpaceOnUse"><stop/><stop offset="1" stop-opacity="0"/></linearGradient>
                                <linearGradient id="i" x1="1380" x2="1028" y1="419" y2="419" gradientUnits="userSpaceOnUse"><stop/><stop offset="1" stop-opacity="0"/></linearGradient>
                                <linearGradient id="j" x1="1362" x2="1156" y1="273" y2="279" gradientUnits="userSpaceOnUse"><stop/><stop offset="1" stop-opacity="0"/></linearGradient>
                                <radialGradient id="k" cx="0" cy="0" r="1" gradientTransform="rotate(90 -196.253 673.007) scale(68.7412)" gradientUnits="userSpaceOnUse"><stop offset=".51" stop-color="#fff"/><stop offset=".51"/></radialGradient>
                            </defs>
                        </svg>
                    </span>
                </span>
                ...
                <span class="astrobear__container">
                    <span class="astrobear">
                        <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 316 432">
                            ...
                            <defs>
                                <linearGradient id="aa" x1="158" x2="158" y1="0" y2="286" gradientUnits="userSpaceOnUse"><stop offset=".219" /><stop offset="1" stop-color="#fff" /></linearGradient>
                                <linearGradient id="bb" x1="254" x2="100" y1="419" y2="325" gradientUnits="userSpaceOnUse"><stop stop-opacity=".98" /><stop offset="1" stop-opacity="0" /></linearGradient>
                                <radialGradient id="cc" cx="0" cy="0" r="1" gradientTransform="matrix(165.9998 58.9999 -60.6938 170.7657 210 171)" gradientUnits="userSpaceOnUse"><stop offset=".771" stop-color="#D9D9D9" stop-opacity="0" /><stop offset="1" stop-color="#fff" stop-opacity=".63" /></radialGradient>
                                <clipPath id="dd"><path fill="#fff" d="M189 291h47v45h-47z" /></clipPath>
                            </defs>
                        </svg>
                    </span>
                </span>
        ...
        button.addEventListener("click", () => {
            ...
            // 交给动画引擎
            if (window.ThemeAnim) {
                window.ThemeAnim.play(next, clickX, clickY);
            } else {
